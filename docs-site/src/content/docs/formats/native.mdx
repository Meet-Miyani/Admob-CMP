...
Native ads are also the format with the most asymmetric support
across the Kotlin Multiplatform AdMob wrapper ecosystem. Most
wrappers stop at the three full-screen-plus-banner formats and
treat native as a "future" feature. AdMob CMP supports native
today because the publisher feed pattern is the most common reason
people reach for an AdMob SDK in the first place.
